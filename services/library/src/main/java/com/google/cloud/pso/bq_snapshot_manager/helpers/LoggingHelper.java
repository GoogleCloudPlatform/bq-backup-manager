...
public class LoggingHelper {
    ...
    public LoggingHelper(
            String loggerName, Integer functionNumber, String projectId, String applicationName) {
    ...
    public void logDebugWithTracker(
            Boolean isDryRun, String tracker, @Nullable TableSpec tableSpec, String msg) {
    ...
    public void logInfoWithTracker(
            Boolean isDryRun, String tracker, @Nullable TableSpec tableSpec, String msg) {
    ...
    public void logWarnWithTracker(
            Boolean isDryRun, String tracker, @Nullable TableSpec tableSpec, String msg) {
    ...
    public void logSevereWithTracker(
            Boolean isDryRun, String tracker, @Nullable TableSpec tableSpec, String msg) {
    ...
    public void logDispatcherCounters(
            String runId,
            Boolean isDryRun,
        ...
        String msg =
                "Execution Timers for %s dispatcher (ms): {'tables_count': %s, 'total': %s, 'listing_scope': %s, 'publish_to_pubsub': %s, 'create_dispatcher_log': %s}";
    ...
    public void logSuccessDispatcherDataset(String runId, DispatcherTableRequest request) {
        ...
        Object[] attributes =
                new Object[] {
                    kv(
                            "dispatched_datasetspec",
                            request.getDatasetSpec() != null
                                    ? request.getDatasetSpec().toSqlString()
                                    : null),
                    kv(
                            "dispatched_datasetspec_project",
                            request.getDatasetSpec() != null
                                    ? request.getDatasetSpec().getProject()
                                    : null),
                    kv(
                            "dispatched_datasetspec_dataset",
                            request.getDatasetSpec() != null
                                    ? request.getDatasetSpec().getDataset()
                                    : null),
                };
    ...
    public void logFailedDispatcherEntityId(
        ...
        logWithTracker(
                ...
                tableSpec,
                String.format(
                        "Failed to process entity `%s`.Exception: %s. Msg: %s",
                        entityId, exceptionClassName, exceptionMessage),
                Level.ERROR,
                attributes);
    }
    ...
    public void logNonRetryableExceptions(
            String trackingId, @Nullable TableSpec tableSpec, Exception ex) {
        ...
        logWithTracker(
                ...
                tableSpec,
                String.format(
                        "Caught a Non-Retryable exception while processing tracker `%s`. %s.",
                        trackingId, generateExceptionSummary(ex)),
                Level.ERROR,
                attributes);
        ex.printStackTrace();
    }
    ...
    public void logRetryableExceptions(
            String trackingId, @Nullable TableSpec tableSpec, Exception ex, String reason) {
        ...
        logWithTracker(
                ...
                tableSpec,
                String.format(
                        "Caught a Retryable exception while processing tracker `%s`. %s. Classification Reason: %s.",
                        trackingId, generateExceptionSummary(ex), reason),
                Level.WARN,
                attributes);
        ex.printStackTrace();
    }
    ...
    private void logFunctionLifeCycleEvent(
            String trackingId, @Nullable TableSpec tableSpec, FunctionLifeCycleEvent event) {
    ...
    public void logUnified(
        ...
        Object[] attributes =
                new Object[] {
                    ...
                    kv(
                            "unified_target_table",
                            targetTable != null ? targetTable.toSqlString() : null),
                    kv("unified_input_json", inputJson != null ? inputJson.toJsonString() : null),
                    kv(
                            "unified_output_json",
                            outputJson != null ? outputJson.toJsonString() : null),
                    kv("unified_is_successful", String.valueOf(isSuccess)),
                    kv(
                            "unified_error",
                            exception != null ? ExceptionUtils.getStackTrace(exception) : null),
        ...
        logWithTracker(
                ...
                targetTable,
                String.format(
                        "Unified log event for component '%s' processing target table '%s' with isSuccess status = '%s' and isRetryable = '%s'",
                        component,
    ...
    private void logWithTracker(
        ...
        Object[] globalAttributes =
                new Object[] {
                    ...
                    kv(
                            "global_tablespec_project",
                            tableSpec == null ? null : tableSpec.getProject()),
                    kv(
                            "global_tablespec_dataset",
                            tableSpec == null ? null : tableSpec.getDataset()),
        ...
        logger.info(
                payload,
                Stream.concat(Arrays.stream(globalAttributes), Arrays.stream(extraAttributes))
                        .toArray());
    }
    ...
    public String generateExceptionSummary(Exception ex) {
        ...
        if (BigQueryException.class.isAssignableFrom(ex.getClass())) {
            ...
            return String.format(
                    "Name: BigQueryException. Msg: %s.Reason: %s. Code: %s",
                    bigQueryException.getMessage(),
                    bigQueryException.getReason(),
                    bigQueryException.getCode());
        } else {
            return String.format("Name: %s. Msg: %s", ex.getClass().getName(), ex.getMessage());
        }
    }
}
