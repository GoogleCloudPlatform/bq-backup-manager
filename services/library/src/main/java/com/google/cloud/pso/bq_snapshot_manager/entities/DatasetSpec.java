...
public class DatasetSpec {
  ...
  public static DatasetSpec fromSqlString(String sqlDatasetId) {
    ...
    return new DatasetSpec(targetDatasetSpecs.get(0), targetDatasetSpecs.get(1));
  }
  ...
  public static DatasetSpec fromFullResource(String fullResource) {
    ...
    return new DatasetSpec(tokens.get(2), tokens.get(4));
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(project, tableSpec.project) && Objects.equals(dataset, tableSpec.dataset);
  }
  ...
  public String toString() {
    return "DatasetSpec{" + "project='" + project + '\'' + ", dataset='" + dataset + '\'' + '}';
  }
}
