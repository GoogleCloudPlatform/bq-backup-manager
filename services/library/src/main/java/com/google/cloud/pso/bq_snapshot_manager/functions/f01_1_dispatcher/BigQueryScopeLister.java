...
public class BigQueryScopeLister {
    ...
    public BigQueryScopeLister(
            ResourceScanner resourceScanner, LoggingHelper logger, String runId) {
            ...
            try {
                ...
                if (!checkResults.x()) {
                    ...
                    logger.logInfoWithTracker(
                            ...
                            null,
                            String.format(
                                    "Dataset %s is excluded by %s", dataset, checkResults.y()));
                }
        ...
        for (String project : projectIncludeList) {
            try {
                ...
                if (!checkResults.x()) {
                    ...
                    logger.logInfoWithTracker(
                            runId, null, String.format("Inspecting project %s", project));
                    ...
                    logger.logInfoWithTracker(
                            ...
                            null,
                            String.format(
                                    "Project %s is excluded by %s", project, checkResults.y()));
                }
    ...
    private List<DatasetSpec> processFolders(
        ...
        for (Long folder : folderIncludeList) {
            try {
                ...
                logger.logInfoWithTracker(
                        runId, null, String.format("Inspecting folder %s", folder));
                ...
                if (folderProjects.isEmpty()) {
                    ...
                    logger.logInfoWithTracker(
                            ...
                            null,
                            String.format(
                                    "Found %s projects under folder %s",
                                    folderProjects.size(), folder));
                }
