        ...
        */
        ...
        if (persistentSet.contains(flagFileName)) {
            ...
            logger.logInfoWithTracker(
                    ...
                    null,
                    String.format(
                            "Persisting processing key for PubSub message ID %s", pubSubMessageId));
        ...
        logger.logInfoWithTracker(
                runId,
                null,
                "Starting to list down datasets in scope and prepare pubsub messages..");
        ...
        logger.logInfoWithTracker(
                ...
                null,
                String.format(
                        "Finished listing down datasets in-scope in %s ms.",
        ...
        logger.logInfoWithTracker(
                ...
                null,
                String.format(
                        "Starting to publish to PubSub: %s messages",
        ...
        logger.logInfoWithTracker(
                runId, null, "Starting to list creating dispatched datasets log..");
        ...
        logger.logInfoWithTracker(
                ...
                null,
                String.format(
                        "Finished creating dispatched datasets log in %s ms.",
                        listingEndTs - listingStartTs));
