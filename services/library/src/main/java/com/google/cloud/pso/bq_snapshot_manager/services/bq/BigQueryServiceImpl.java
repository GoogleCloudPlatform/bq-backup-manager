...
public class BigQueryServiceImpl implements BigQueryService {
    ...
    public void createSnapshot(
        ...
        CopyJobConfiguration copyJobConfiguration =
                CopyJobConfiguration.newBuilder(
                                destinationTable.toTableId(), sourceTable.toTableId())
        ...
        Job job =
                bigQuery.create(
                        JobInfo.newBuilder(copyJobConfiguration).setJobId(JobId.of(jobId)).build());
    ...
    public void exportToGCS(
        ...
        bigQuery.create(
                JobInfo.newBuilder(extractConfigurationBuilder.build())
