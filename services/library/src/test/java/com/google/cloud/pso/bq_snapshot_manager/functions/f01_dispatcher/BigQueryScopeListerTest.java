...
public class BigQueryScopeListerTest {
  ...
  public void testOnTableLevel() throws NonRetryableApplicationException {
    ...
    List<TableSpec> expected =
        Lists.newArrayList(
            TableSpec.fromSqlString("p1.d1.t1"), TableSpec.fromSqlString("p1.d1.t2"));
  ...
  public void testExcludeWithRegex() throws NonRetryableApplicationException {
    ...
    List<TableSpec> actual = lister.listTablesInScope(bigQueryScope);
    List<TableSpec> expected = Lists.newArrayList(TableSpec.fromSqlString("p2.d2.t1"));
