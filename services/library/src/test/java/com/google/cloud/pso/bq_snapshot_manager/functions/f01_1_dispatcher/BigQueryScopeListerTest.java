...
public class BigQueryScopeListerTest {
    ...
    public void testOnDatasetLevel() throws NonRetryableApplicationException {
        ...
        BigQueryScope bigQueryScope =
                new BigQueryScope(
                        ...
                        Arrays.asList(
                                "p1.d2",
                                "p2.d2"), // datasets include - should be the only include list
                        // affecting the scope
        ...
        List<DatasetSpec> expected =
                Lists.newArrayList(
                        DatasetSpec.fromSqlString("p1.d2"), DatasetSpec.fromSqlString("p2.d2"));
    ...
    public void testOnProjectLevel() throws NonRetryableApplicationException {
        ...
        BigQueryScope bigQueryScope =
                new BigQueryScope(
                        new ArrayList<>(), // folders - should have no effect
                        Arrays.asList(
                                "p1", "p2"), // projects include - should be the only include list
                        // affecting the scope
                        new ArrayList<>(), // projects exclude
    ...
    public void testOnFolderLevel() throws NonRetryableApplicationException {
        ...
        BigQueryScope bigQueryScope =
                new BigQueryScope(
                        Arrays.asList(
                                1L, 2L), // folders - should be the only include list affecting the
                        // scope
                        Arrays.asList(),
    ...
    public void testExcludeWithRegex() throws NonRetryableApplicationException {
        ...
        BigQueryScope bigQueryScope =
                new BigQueryScope(
                        ...
                        Arrays.asList(
                                "p3",
                                "regex:^p4$"), // projects exclude - p3 as literal and p4 as regex
                        Arrays.asList(), // datasets include - should have no effect
                        Arrays.asList(
                                "regex:.*\\.d1$",
                                "P1.D2"), // datasets exclude: all datasets ending with d1 and p1.d2
                        Arrays.asList(), // tables include - should be the only scope
                        Arrays.asList() // regex to exclude tables ending with t2 suffix
                        );

        List<DatasetSpec> actual = lister.listDatasetsInScope(bigQueryScope);
        List<DatasetSpec> expected = Lists.newArrayList(DatasetSpec.fromSqlString("p2.d2"));
