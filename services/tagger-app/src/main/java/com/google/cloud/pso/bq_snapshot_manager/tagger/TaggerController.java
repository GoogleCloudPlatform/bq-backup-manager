...
public class TaggerController {
    ...
    public ResponseEntity receiveMessage(@RequestBody PubSubEvent requestBody) {
        ...
        try {
            ...
            // 2. From a log sink listening for BQ export job completion events. These jobs are
            // originally
            ...
            if (isGCSExportJobMessage) {
                ...
                String taggerRequestFile =
                        String.format("%s/%s", "snapshoter-gcs-tagger-requests", jobId);
                ...
                // After parsing the taggerRequest for tracking, throw a non retryable exception if
                // the
                // backup job failed
                if (!isSuccessfulJob) {
                    String msg =
