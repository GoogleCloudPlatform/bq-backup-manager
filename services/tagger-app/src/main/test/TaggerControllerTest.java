...
public class TaggerControllerTest {
  ...
  public void testParsingJobCompletionEvent() {
    ...
    assertEquals(
        TaggerController.getGcsExportJobLabel(testEvent, "tracking_id"), "test-tracking-id");

    assertEquals(
        TaggerController.getGcsExportJobLabel(testEvent, "table_spec"), "project.dataset.table");
    ...
    assertEquals(TaggerController.getGcsExportJobError(testEvent), "NA");
  }
}
